...
def open_vista_licencia(root):
    ...
    vista_licencia.title('Gestor Autos - Licencia')
    vista_licencia.iconbitmap('img/autito.ico')
...
class Frame5(Frame):
    ...
    def ver_licencia(self):
        self.label_licencia= tk.Label(self,text= '''Sistema CRUD en Python para la materia PROG1 
    Copyright (C) 2024 
